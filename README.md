This repository contains contains a script that will automate the installation of a cronjob that will run a python script every minute and record the Public IP of the host machine.
